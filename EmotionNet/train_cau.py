...
class_labels = ['기쁨', '분노', '슬픔', '중립']
class_labels_dict = {'기쁨': 0, '분노': 1, '슬픔': 2, '중립': 3}


def get_dataloader(args):
    classes_train = os.listdir(args.data_path + "/train")
    classes_valid = os.listdir(args.data_path + "/val")
    ...
    train_dataset = ImageFolder(args.data_path + '/train', train_transforms)
...
def main():
    ...
    parser.add_argument('--data_path', action='store',
                        default='data/ai_hub', help='path of data folder')
    parser.add_argument('--model_path', action='store',
                        default='model_cau_eff.pth', help='path of model file')
    parser.add_argument('--model', action='store',
                        default='efficientnet-b4', help='network architecture')
